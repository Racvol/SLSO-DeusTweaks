...
;/ 	int i = TagList.Length
 ...
 /;
	...
	Tags = PapyrusUtil.MergeStringArray(GetTags(), TagList, True)
 endFunction
...
;  ToDo: Update with a faster PapyrusUtil function once be made
...
;/ 	int i = TagList.Length
	...
	return false
 /;	
 	string[] CleanTagList = PapyrusUtil.RemoveString(TagList, "")
	return CleanTagList.Length > 0 && PapyrusUtil.GetMatchingString(Tags, CleanTagList).Length > 0
endFunction
...
;/ 	int i = TagList.Length
 ...
 /;
 	string[] CleanTagList = PapyrusUtil.RemoveString(TagList, "")
	return CleanTagList.Length < 1 || PapyrusUtil.GetMatchingString(Tags, CleanTagList).Length == CleanTagList.Length
endFunction
