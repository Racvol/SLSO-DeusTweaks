...
function Page_Config()
	SetCursorFillMode(TOP_TO_BOTTOM)
		AddHeaderOption("$Config_Orgasm_event_configuration_Header_1")
			...
			AddSliderOptionST("mental_damage_tweak", "$mental_damage_tweak", (JsonUtil.GetFloatValue(File, "mental_damage_tweak")*100) as int , "{0}%")
			AddSliderOptionST("mental_damage_tweak_player", "$mental_damage_tweak_player", (JsonUtil.GetFloatValue(File, "mental_damage_tweak_player")*100) as int , "{0}%")
		...
		AddHeaderOption("$Config_Orgasm_event_configuration_Header_2")
			...
			AddSliderOptionST("condition_chance_minimum_consensual_orgasm_increase", "$condition_chance_minimum_consensual_orgasm_increase", JsonUtil.GetIntValue(File, "condition_chance_minimum_consensual_orgasm_increase"), "{0}%")
			...
			AddToggleOptionST("condition_arousal_consensual_orgasm", "$condition_arousal_consensual_orgasm", JsonUtil.GetIntValue(File, "condition_arousal_consensual_orgasm"))
			AddToggleOptionST("condition_arousal_aggressor_orgasm", "$condition_arousal_aggressor_orgasm", JsonUtil.GetIntValue(File, "condition_arousal_aggressor_orgasm"))
			...
			AddSliderOptionST("condition_minimum_aggressor_temper", "$condition_minimum_aggressor_temper", (JsonUtil.GetFloatValue(File, "condition_minimum_aggressor_temper")*100) as int , "{0}%")
			AddSliderOptionST("condition_maximum_aggressor_temper", "$condition_maximum_aggressor_temper", (JsonUtil.GetFloatValue(File, "condition_maximum_aggressor_temper")*100) as int , "{0}%")
			...
			elseif JsonUtil.GetIntValue(File, "condition_victim_orgasm") == 3
				AddTextOptionST("condition_victim_orgasm", "$condition_victim_orgasm", "$condition_victim_orgasm_s3")
			elseif JsonUtil.GetIntValue(File, "condition_victim_orgasm") == 4
				AddTextOptionST("condition_victim_orgasm", "$condition_victim_orgasm", "$condition_victim_orgasm_s4")
			else
			...
			elseif JsonUtil.GetIntValue(File, "condition_victim_arousal") == 3
				AddTextOptionST("condition_victim_arousal", "$condition_victim_arousal", "$condition_victim_arousal_s3")
			elseif JsonUtil.GetIntValue(File, "condition_victim_arousal") == 4
				AddTextOptionST("condition_victim_arousal", "$condition_victim_arousal", "$condition_victim_arousal_s4")
			else
				AddTextOptionST("condition_victim_arousal", "$condition_victim_arousal", "$condition_victim_arousal_s0")
			endif

			AddToggleOptionST("condition_victim_orgasm_aggressor_broken", "$condition_victim_orgasm_aggressor_broken", JsonUtil.GetIntValue(File, "condition_victim_orgasm_aggressor_broken"))
			AddEmptyOption()
		
		AddHeaderOption("$Config_Orgasm_event_configuration_Header_3")

			AddSliderOptionST("slso_schlong_size_enjoyment_bonus", "$slso_schlong_size_enjoyment_bonus", JsonUtil.GetIntValue(File, "slso_schlong_size_enjoyment_bonus"), "{0}")
			AddToggleOptionST("slso_schlong_size_oral_bonus", "$slso_schlong_size_oral_bonus", JsonUtil.GetIntValue(File, "slso_schlong_size_oral_bonus"))
			AddSliderOptionST("slso_schlong_size_curve", "$slso_schlong_size_curve", (JsonUtil.GetFloatValue(File, "slso_schlong_size_curve")*100) as int , "{0}%")
			AddSliderOptionST("slso_schlong_size_medium", "$slso_schlong_size_medium", JsonUtil.GetIntValue(File, "slso_schlong_size_medium"), "{0}")
			AddToggleOptionST("slso_schlong_size_mind_break", "$slso_schlong_size_mind_break", JsonUtil.GetIntValue(File, "slso_schlong_size_mind_break"))
			AddToggleOptionST("slso_creature_size_bonus", "$slso_creature_size_bonus", JsonUtil.GetIntValue(File, "slso_creature_size_bonus"))
		...
		AddHeaderOption("$Config_Misc_configuration_Header")
			...
			AddSliderOptionST("sl_multiorgasmchance_male", "$sl_multiorgasmchance_male", JsonUtil.GetIntValue(File, "sl_multiorgasmchance_male"))
	...
	SetCursorPosition(1)
		...
		AddHeaderOption("$Config_Game_Header_3")
			...
			AddSliderOptionST("minimum_stage_time", "$minimum_stage_time", JsonUtil.GetIntValue(File, "minimum_stage_time"))
...
;			AddKeyMapOptionST("hotkey_orgasm", "$hotkey_orgasm", JsonUtil.GetIntValue(File, "hotkey_orgasm"))
			...
			AddKeyMapOptionST("hotkey_resist", "$hotkey_resist", JsonUtil.GetIntValue(File, "hotkey_resist"))
			AddKeyMapOptionST("hotkey_display_mode", "$hotkey_display_mode", JsonUtil.GetIntValue(File, "hotkey_display_mode"))
			AddToggleOptionST("condition_display_mode_global", "$condition_display_mode_global", JsonUtil.GetIntValue(File, "condition_display_mode_global"))
endfunction
...
state minimum_stage_time
	event OnSliderOpenST()
		SetSliderDialogStartValue(JsonUtil.GetIntValue(File, "minimum_stage_time"))
		SetSliderDialogDefaultValue(3)
	...
	event OnSliderAcceptST(float value)
		JsonUtil.SetIntValue(File, "minimum_stage_time", value as int)
		SetSliderOptionValueST(JsonUtil.GetIntValue(File, "minimum_stage_time"))
	endEvent
	
	event OnHighlightST()
		SetInfoText("$minimum_stage_time_description")
	endEvent
endState
...
state condition_minimum_aggressor_temper
	event OnSliderOpenST()
		SetSliderDialogStartValue((JsonUtil.GetFloatValue(File, "condition_minimum_aggressor_temper")*100) as int)
	...
	event OnSliderAcceptST(float value)
		JsonUtil.SetFloatValue(File, "condition_minimum_aggressor_temper", value/100)
		SetSliderOptionValueST((JsonUtil.GetFloatValue(File, "condition_minimum_aggressor_temper")*100) as int, "{0}%")
	endEvent

	event OnHighlightST()
		SetInfoText("$condition_minimum_aggressor_temper_description")
	endEvent
endState


state condition_maximum_aggressor_temper
	event OnSliderOpenST()
		SetSliderDialogStartValue((JsonUtil.GetFloatValue(File, "condition_maximum_aggressor_temper")*100) as int)
	...
	event OnSliderAcceptST(float value)
		JsonUtil.SetFloatValue(File, "condition_maximum_aggressor_temper", value/100)
		SetSliderOptionValueST((JsonUtil.GetFloatValue(File, "condition_maximum_aggressor_temper")*100) as int, "{0}%")
	endEvent

	event OnHighlightST()
		SetInfoText("$condition_maximum_aggressor_temper_description")
	endEvent
endState

state mental_damage_tweak
	event OnSliderOpenST()
		SetSliderDialogStartValue((JsonUtil.GetFloatValue(File, "mental_damage_tweak")*100) as int)
		SetSliderDialogDefaultValue(100)
		SetSliderDialogRange(0, 500)
		SetSliderDialogInterval(1)
	endEvent
	...
	event OnSliderAcceptST(float value)
		JsonUtil.SetFloatValue(File, "mental_damage_tweak", value/100)
		SetSliderOptionValueST((JsonUtil.GetFloatValue(File, "mental_damage_tweak")*100) as int, "{0}%")
	endEvent

	event OnHighlightST()
		SetInfoText("$mental_damage_tweak_description")
	endEvent
endState

state mental_damage_tweak_player
	event OnSliderOpenST()
		SetSliderDialogStartValue((JsonUtil.GetFloatValue(File, "mental_damage_tweak_player")*100) as int)
		SetSliderDialogDefaultValue(100)
		SetSliderDialogRange(0, 500)
		SetSliderDialogInterval(1)
	endEvent
	...
	event OnSliderAcceptST(float value)
		JsonUtil.SetFloatValue(File, "mental_damage_tweak_player", value/100)
		SetSliderOptionValueST((JsonUtil.GetFloatValue(File, "mental_damage_tweak_player")*100) as int, "{0}%")
	endEvent

	event OnHighlightST()
		SetInfoText("$mental_damage_tweak_player_description")
	endEvent
endState

state condition_chance_minimum_consensual_orgasm_increase
	event OnSliderOpenST()
		SetSliderDialogStartValue(JsonUtil.GetIntValue(File, "condition_chance_minimum_consensual_orgasm_increase"))
		SetSliderDialogDefaultValue(0)
		SetSliderDialogRange(0, 100)
		SetSliderDialogInterval(1)
	endEvent
	...
	event OnSliderAcceptST(float value)
		JsonUtil.SetIntValue(File, "condition_chance_minimum_consensual_orgasm_increase", value as int)
		SetSliderOptionValueST(JsonUtil.GetIntValue(File, "condition_chance_minimum_consensual_orgasm_increase"), "{0}%")
	endEvent
	
	event OnHighlightST()
		SetInfoText("$condition_chance_minimum_consensual_orgasm_increase_description")
	endEvent
endState
...
state sl_multiorgasmchance_male
	event OnSliderOpenST()
		SetSliderDialogStartValue(JsonUtil.GetIntValue(File, "sl_multiorgasmchance_male"))
	...
	event OnSliderAcceptST(float value)
		JsonUtil.SetIntValue(File, "sl_multiorgasmchance_male", value as int)
		SetSliderOptionValueST(JsonUtil.GetIntValue(File, "sl_multiorgasmchance_male"))
	endEvent
	
	event OnHighlightST()
		SetInfoText("$sl_multiorgasmchance_male_description")
	endEvent
endState
...
state condition_display_mode_global
	event OnSelectST()
		if JsonUtil.GetIntValue(File, "condition_display_mode_global") == 1
			JsonUtil.SetIntValue(File, "condition_display_mode_global", 0)
		else
			JsonUtil.SetIntValue(File, "condition_display_mode_global", 1)
		endif
		SetToggleOptionValueST(JsonUtil.GetIntValue(File, "condition_display_mode_global"))
	endEvent
	
	event OnHighlightST()
		SetInfoText("$condition_display_mode_global_description")
	endEvent
endState
...
state condition_arousal_consensual_orgasm
	event OnSelectST()
		if JsonUtil.GetIntValue(File, "condition_arousal_consensual_orgasm") == 1
			JsonUtil.SetIntValue(File, "condition_arousal_consensual_orgasm", 0)
		else
			JsonUtil.SetIntValue(File, "condition_arousal_consensual_orgasm", 1)
		endif
		SetToggleOptionValueST(JsonUtil.GetIntValue(File, "condition_arousal_consensual_orgasm"))
	endEvent
	
	event OnHighlightST()
		SetInfoText("$condition_arousal_consensual_orgasm_description")
	endEvent
endState

state condition_arousal_aggressor_orgasm
	event OnSelectST()
		if JsonUtil.GetIntValue(File, "condition_arousal_aggressor_orgasm") == 1
			JsonUtil.SetIntValue(File, "condition_arousal_aggressor_orgasm", 0)
		else
			JsonUtil.SetIntValue(File, "condition_arousal_aggressor_orgasm", 1)
		endif
		SetToggleOptionValueST(JsonUtil.GetIntValue(File, "condition_arousal_aggressor_orgasm"))
	endEvent
	
	event OnHighlightST()
		SetInfoText("$condition_arousal_aggressor_orgasm_description")
	endEvent
endState
...
state condition_victim_orgasm
	event OnSelectST()
		...
		elseif JsonUtil.GetIntValue(File, "condition_victim_orgasm") == 0
			JsonUtil.SetIntValue(File, "condition_victim_orgasm", 3)
			value = "$condition_victim_orgasm_s3"
		elseif JsonUtil.GetIntValue(File, "condition_victim_orgasm") == 3
			JsonUtil.SetIntValue(File, "condition_victim_orgasm", 4)
			value = "$condition_victim_orgasm_s4"
		else
...
state condition_victim_arousal
	event OnSelectST()
		...
		elseif JsonUtil.GetIntValue(File, "condition_victim_arousal") == 0
			JsonUtil.SetIntValue(File, "condition_victim_arousal", 3)
			value = "$condition_victim_arousal_s3"
		elseif JsonUtil.GetIntValue(File, "condition_victim_arousal") == 3
			JsonUtil.SetIntValue(File, "condition_victim_arousal", 4)
			value = "$condition_victim_arousal_s4"
		else
...
state condition_victim_orgasm_aggressor_broken
	event OnSelectST()
		if JsonUtil.GetIntValue(File, "condition_victim_orgasm_aggressor_broken") == 1
			JsonUtil.SetIntValue(File, "condition_victim_orgasm_aggressor_broken", 0)
		else
			JsonUtil.SetIntValue(File, "condition_victim_orgasm_aggressor_broken", 1)
		endif
		SetToggleOptionValueST(JsonUtil.GetIntValue(File, "condition_victim_orgasm_aggressor_broken"))
	endEvent
	
	event OnHighlightST()
		SetInfoText("$condition_victim_orgasm_aggressor_broken_description")
	endEvent
endState

state slso_schlong_size_enjoyment_bonus
	event OnSliderOpenST()
		SetSliderDialogStartValue(JsonUtil.GetIntValue(File, "slso_schlong_size_enjoyment_bonus"))
		SetSliderDialogDefaultValue(5)
	...
	event OnSliderAcceptST(float value)
		JsonUtil.SetIntValue(File, "slso_schlong_size_enjoyment_bonus", value as int)
		SetSliderOptionValueST(JsonUtil.GetIntValue(File, "slso_schlong_size_enjoyment_bonus"), "{0}")
	endEvent
	
	event OnHighlightST()
		SetInfoText("$slso_schlong_size_enjoyment_bonus_description")
	endEvent
endState

state slso_schlong_size_oral_bonus
	event OnSelectST()
		if JsonUtil.GetIntValue(File, "slso_schlong_size_oral_bonus") == 1
			JsonUtil.SetIntValue(File, "slso_schlong_size_oral_bonus", 0)
		else
			JsonUtil.SetIntValue(File, "slso_schlong_size_oral_bonus", 1)
		endif
		SetToggleOptionValueST(JsonUtil.GetIntValue(File, "slso_schlong_size_oral_bonus"))
	endEvent
	
	event OnHighlightST()
		SetInfoText("$slso_schlong_size_oral_bonus_description")
	endEvent
endState


state slso_schlong_size_curve
	event OnSliderOpenST()
		SetSliderDialogStartValue((JsonUtil.GetFloatValue(File, "slso_schlong_size_curve")*100) as int)
		SetSliderDialogDefaultValue(200)
		SetSliderDialogRange(100, 400)
		SetSliderDialogInterval(1)
	endEvent

	event OnSliderAcceptST(float value)
		JsonUtil.SetFloatValue(File, "slso_schlong_size_curve", value/100)
		SetSliderOptionValueST((JsonUtil.GetFloatValue(File, "slso_schlong_size_curve")*100) as int)
	endEvent

	event OnHighlightST()
		SetInfoText("$slso_schlong_size_curve_description")
	endEvent
endState

state slso_schlong_size_medium
	event OnSliderOpenST()
		SetSliderDialogStartValue(JsonUtil.GetIntValue(File, "slso_schlong_size_medium"))
	...
	event OnSliderAcceptST(float value)
		JsonUtil.SetIntValue(File, "slso_schlong_size_medium", value as Int)
		SetSliderOptionValueST(JsonUtil.GetIntValue(File, "slso_schlong_size_medium"), "{0}")
	endEvent
	
	event OnHighlightST()
		SetInfoText("$slso_schlong_size_medium_description")
	endEvent
endState

state slso_schlong_size_mind_break
	event OnSelectST()
		if JsonUtil.GetIntValue(File, "slso_schlong_size_mind_break") == 1
			JsonUtil.SetIntValue(File, "slso_schlong_size_mind_break", 0)
		else
			JsonUtil.SetIntValue(File, "slso_schlong_size_mind_break", 1)
		endif
		SetToggleOptionValueST(JsonUtil.GetIntValue(File, "slso_schlong_size_mind_break"))
	endEvent
	
	event OnHighlightST()
		SetInfoText("$slso_schlong_size_mind_break_description")
	endEvent
endState

state slso_creature_size_bonus
	event OnSelectST()
		if JsonUtil.GetIntValue(File, "slso_creature_size_bonus") == 1
			JsonUtil.SetIntValue(File, "slso_creature_size_bonus", 0)
		else
			JsonUtil.SetIntValue(File, "slso_creature_size_bonus", 1)
		endif
		SetToggleOptionValueST(JsonUtil.GetIntValue(File, "slso_creature_size_bonus"))
	endEvent
	
	event OnHighlightST()
		SetInfoText("$slso_creature_size_bonus_description")
	endEvent
endState
...
state hotkey_resist
	event OnKeyMapChangeST(int newKeyCode, string conflictControl, string conflictName)
		...
		; Set allowed key change
		if continue
			JsonUtil.SetIntValue(File, "hotkey_resist", newKeyCode)
			SetKeyMapOptionValueST(JsonUtil.GetIntValue(File, "hotkey_resist"))
		endIf
		RegisterForKey(JsonUtil.GetIntValue(File, "hotkey_resist"))
	endEvent

	event OnHighlightST()
		SetInfoText("$hotkey_resist_description")
	endEvent
endState

state hotkey_display_mode
	event OnKeyMapChangeST(int newKeyCode, string conflictControl, string conflictName)
		UnregisterForAllKeys()
		bool continue = true
		...
		; Set allowed key change
		if continue
			JsonUtil.SetIntValue(File, "hotkey_display_mode", newKeyCode)
			SetKeyMapOptionValueST(JsonUtil.GetIntValue(File, "hotkey_display_mode"))
		endIf
		RegisterForKey(JsonUtil.GetIntValue(File, "hotkey_display_mode"))
	endEvent

	event OnHighlightST()
		SetInfoText("$hotkey_display_mode_description")
	endEvent
endState
;=============================================================
;Widgets
