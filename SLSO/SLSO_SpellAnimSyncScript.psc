...
Event OnEffectFinish( Actor akTarget, Actor akCaster )
	If akTarget != none
		if (SKSE.GetPluginVersion("animspeed plugin") > 0)
			...
			;SexLab.Log(" SLSO AnimSpeed()(OnEffectFinish1) actor: " + akTarget.GetDisplayName() + " speed: " + AnimSpeedHelper.GetAnimationSpeed(akTarget, false))
			AnimSpeedHelper.SetAnimationSpeed(akTarget, 1, 0, false)
			;SexLab.Log(" SLSO AnimSpeed()(OnEffectFinish2) actor: " + akTarget.GetDisplayName() + " speed: " + AnimSpeedHelper.GetAnimationSpeed(akTarget, false))
		endif
	EndIf
EndEvent
