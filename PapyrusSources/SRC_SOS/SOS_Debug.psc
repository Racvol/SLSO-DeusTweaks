...
Event OnEffectStart(Actor akTarget, Actor akCaster)
	...
	If bodyArmor
		...
		revealingKeyword = SOS_Quest.HasRevealingKeyword(bodyArmor)
		concealingFormList = (Game.GetFormFromFile(0xD72, "Schlongs of Skyrim - Core.esm") as FormList).HasForm(bodyArmor)
		revealingFormList = !revealingKeyword && SOS_Quest.IsRevealing(bodyArmor)
	EndIf
